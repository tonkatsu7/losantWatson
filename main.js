...
var textToSpeech = watson.text_to_speech({
  username: 'fd02675f-27b0-4fbd-a145-215e28ff90f8',
  password: 'Za2hOCnthtLv',
  version: 'v1'
});

// initialize watson speech-to-text service
var speechToText = watson.speech_to_text({
  username: 'd9143e49-9a57-4cfb-9a69-5c6333fcc013',
  password: 'p2b2lYFsYFAr',
  version: 'v1'
});
...
function search (q, cb) {
  if (!q) {
    return cb(null, 'I\'m so sorry Rafael I didn\'t hear you.');
  }
